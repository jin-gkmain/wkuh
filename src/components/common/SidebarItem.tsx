          ...
          {type === 'appointments' && (
            <div className="dates flex flex-col gap-3">
              <p className="flex gap-3">
                <FlagMongolSq />
                {'te_date' in item
                  ? convertTimeToStr('MN', item.te_date, null, format)
                  : ''}
                {'vii_tad' in item
                  ? convertTimeToStr('MN', item.vii_tad, null, format)
                  : ''}
              </p>
              <p className="flex gap-3">
                <FlagKoreaSq />
                {'te_date' in item
                  ? convertTimeToStr('KR', item.te_date, null, format)
                  : ''}
                {'vii_tad' in item
                  ? convertTimeToStr('KR', item.vii_tad, null, format)
                  : ''}
              </p>
            </div>
          )}
