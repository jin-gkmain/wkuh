...
const QRCodeModal: React.FC<Props> = ({ qrString, fileName = 'qr-code', closeModal }) => {
  ...
  return (
    <ModalFrame 
      title={langFile[lang].QR_CODE_MODAL_TITLE || "QR 코드"}
      onClose={closeModal}
      hideBtns={true}
      width="small"
    >
      <div className="qr-code-modal-container">
        <div className="qr-code-wrapper flex flex-col items-center">
          ...
          <div className="qr-download-buttons flex justify-center gap-4 mt-4">
            ...
            >
              {langFile[lang].DOWNLOAD_PNG_BUTTON_TEXT || "PNG 다운로드"}
            </button>
          </div>
        </div>
      </div>
