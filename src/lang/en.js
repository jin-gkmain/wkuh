const lang = {
  ...
  USER_JOB_TEXT: "Jobs",
  USER_SPECIALTY_TEXT: "Medical Specialty",
  USER_EMAIL_TEXT: "Email (ID)",
  USER_TEL_TEXT: "Phone Number",
  USER_REGIST_DATE_TEXT: "Created on",
  USER_TABLE_ROW_BUTTON_TEXT: "Manage",
  USER_MODAL_USER_SPECIALTY1: "General Internal Medicine",
  USER_MODAL_USER_SPECIALTY2: "Gastroenterology",
  USER_MODAL_USER_SPECIALTY3: "Pulmonology",
  USER_MODAL_USER_SPECIALTY4: "Cardiology",
  USER_MODAL_USER_SPECIALTY5: "Nephrology",
  USER_MODAL_USER_SPECIALTY6: "Endocrinology",
  USER_MODAL_USER_SPECIALTY7: "Hematology & Oncology",
  USER_MODAL_USER_SPECIALTY8: "Infectious Disease",
  USER_MODAL_USER_SPECIALTY9: "Rheumatology",
  USER_MODAL_USER_SPECIALTY10: "Allergy Medicine",
  USER_MODAL_USER_SPECIALTY11: "Neurology",
  USER_MODAL_USER_SPECIALTY12: "General Surgery",
  USER_MODAL_USER_SPECIALTY13: "Thoracic Surgery",
  USER_MODAL_USER_SPECIALTY14: "Neurosurgery",
  USER_MODAL_USER_SPECIALTY15: "Orthopedic Surgery",
  USER_MODAL_USER_SPECIALTY16: "Plastic Surgery",
  USER_MODAL_USER_SPECIALTY17: "Obstetrics & Gynecology",
  USER_MODAL_USER_SPECIALTY18: "Urology",
  USER_MODAL_USER_SPECIALTY19: "Pediatrics",
  USER_MODAL_USER_SPECIALTY20: "Pediatric Surgery",
  USER_MODAL_USER_SPECIALTY21: "Radiology",
  USER_MODAL_USER_SPECIALTY22: "Nuclear Medicine",
  USER_MODAL_USER_SPECIALTY23: "Pathology",
  USER_MODAL_USER_SPECIALTY24: "Psychiatry",
  USER_MODAL_USER_SPECIALTY25: "Rehabilitation Medicine",
  USER_MODAL_USER_SPECIALTY26: "Anesthesiology & Pain Medicine",
  USER_MODAL_USER_SPECIALTY27: "Dermatology",
  USER_MODAL_USER_SPECIALTY28: "Otorhinolaryngology",
  USER_MODAL_USER_SPECIALTY29: "Ophthalmology",
  USER_MODAL_USER_SPECIALTY30: "Family Medicine",
  USER_MODAL_USER_SPECIALTY31: "Dentistry",
  USER_MODAL_USER_SPECIALTY32: "Emergency Medicine",
  USER_MODAL_USER_SPECIALTY33: "Geriatrics",
  USER_MODAL_USER_SPECIALTY34: "Critical Care Medicine",
  USER_MODAL_USER_SPECIALTY35: "Cardiovascular Center",
  USER_MODAL_USER_SPECIALTY36: "Stroke Center",
  USER_MODAL_USER_SPECIALTY37: "Organ Transplantation Center",
  USER_MODAL_USER_SPECIALTY38: "Cancer Center",
  ...
  WORKFLOW_MODAL_PRELIMINARY_NON_DATA: "No preliminary data available.",
  ...
  PAGE_HEADER_HISTORY_LIST_TITLE_TEXT: "History list",
  PAGE_HEADER_HISTORY_LIST_DESC_TEXT: "View and manage your history list",
  ...
  DASHBOARD_CURRENT_POST_STATUS_TITLE: "Pre-consultation status",
  ...
  MOBILE_INDEX_DESC:
    "From pre-consultation questionnaire writing to AI chatbot, receive health care and various medical information easily and smartly.",
  MOBILE_INDEX_PAPERWEIGHT_TITLE: "Write a questionnaire",
  MOBILE_INDEX_PAPERWEIGHT_DESC:
    "Write a simple questionnaire before the consultation to provide accurate information to the medical staff.",
  MOBILE_INDEX_PAPERWEIGHT_BUTTON: "Write",
  MOBILE_INDEX_CHATBOT_TITLE: "Chat with AI",
  MOBILE_INDEX_CHATBOT_DESC:
    "Ask about health, disease, nutrition information easily and smartly with AI.",
  MOBILE_INDEX_CHATBOT_BUTTON: "Chat",

  MOBILE_CHATBOT_INTRO:
    "Do you have any questions about your symptoms? AI will explain medical, health, and nutrition information to you kindly.",
  MOBILE_CHATBOT_INPUT_PLACEHOLDER: "Input your message...",

  MOBILE_PRELIMINARY_NEXT: "NEXT",
  MOBILE_PRELIMINARY_BACK: "PREVIOUS",
  MOBILE_PRELIMINARY_COMPLETE: "COMPLETE",
  MOBILE_PRELIMINARY_START: "START",
  ...
  MOBILE_PRELIMINARY_PATIENNUM_DESC:
    "Please enter the patient number provided by the hospital.",
  MOBILE_PRELIMINARY_PATIENNUM_INPUT_PLACEHOLDER: "Enter the patient number",
  ...
  MOBILE_PRELIMINARY_PATIENTINFO_DESC: "Please check the patient information.",
  MOBILE_PRELIMINARY_PATIENTINFO_INPUT_ERROR: "Please check and enter again.",
  MOBILE_PRELIMINARY_PATIENTNAME_INPUT_DESC: "Name",
  MOBILE_PRELIMINARY_PATIENTNAME_INPUT_PLACEHOLDER: "Enter your name",
  MOBILE_PRELIMINARY_PATIENTBIRTHDAY_INPUT_DESC: "Date of birth",
  MOBILE_PRELIMINARY_PATIENTBIRTHDAY_INPUT_PLACEHOLDER:
    "Select your date of birth",
  MOBILE_PRELIMINARY_PATIENTAGE_INPUT_DESC: "Age",
  MOBILE_PRELIMINARY_PATIENTAGE_INPUT_PLACEHOLDER: "Enter your age",
  MOBILE_PRELIMINARY_PATIENTGENDER_INPUT_DESC: "Gender",
  MOBILE_PRELIMINARY_PATIENTGENDER_INPUT_PLACEHOLDER: "Select your gender",
  MOBILE_PRELIMINARY_PATIENTWEIGHT_INPUT_DESC: "Weight",
  MOBILE_PRELIMINARY_PATIENTWEIGHT_INPUT_PLACEHOLDER: "Enter your weight",
  MOBILE_PRELIMINARY_PATIENTHEIGHT_INPUT_DESC: "Height",
  MOBILE_PRELIMINARY_PATIENTHEIGHT_INPUT_PLACEHOLDER: "Enter your height",

  MOBILE_PRELIMINARY_SYMPTOMS_DESC: "What symptoms are you experiencing?",
  MOBILE_PRELIMINARY_SYMPTOMS_TITLE1: "Headache",
  MOBILE_PRELIMINARY_SYMPTOMS_TITLE2: "Chest pain",
  ...
  MOBILE_PRELIMINARY_PAIN_DEGREE2: "Severe pain",
  MOBILE_PRELIMINARY_PAIN_DEGREE3: "Worst pain",

  MOBILE_PRELIMINARY_DIAGNOSIS_DESC: "What is the diagnosis?",
  MOBILE_PRELIMINARY_DIAGNOSIS_SUBDESC:
    "If you don't know the diagnosis, select `I don't know`",
  MOBILE_PRELIMINARY_DIAGNOSIS_INPUT_PLACEHOLDER: "Enter the diagnosis",
  MOBILE_PRELIMINARY_DIAGNOSIS_NOT_SURE: "I don't know",

  MOBILE_PRELIMINARY_TREATMENT_DESC: "Have you received any treatment?",
  MOBILE_PRELIMINARY_TREATMENT_SUBDESC:
    "If you didn't receive any treatment, select `None`",
  MOBILE_PRELIMINARY_TREATMENT_INPUT_PLACEHOLDER: "Enter the treatment",
  MOBILE_PRELIMINARY_TREATMENT_NOT_SURE: "None",

  MOBILE_PRELIMINARY_SPECIFIC_DESC:
    "Do you want to receive any specific treatment in Korea?",
  MOBILE_PRELIMINARY_SPECIFIC_INPUT_PLACEHOLDER:
    "Enter the specific treatment you want to receive",

  MOBILE_PRELIMINARY_PAST_HISTORY_DESC:
    "If you have any of the following past medical history, please select all of them.",
  MOBILE_PRELIMINARY_PAST_HISTORY_TITLE1: "Hypertension",
  MOBILE_PRELIMINARY_PAST_HISTORY_TITLE2: "Diabetes",
  MOBILE_PRELIMINARY_PAST_HISTORY_TITLE3: "Tuberculosis",
  MOBILE_PRELIMINARY_PAST_HISTORY_TITLE4: "Cancer",
  MOBILE_PRELIMINARY_PAST_HISTORY_TITLE5: "Other",
  MOBILE_PRELIMINARY_PAST_HISTORY_INPUT_PLACEHOLDER:
    "Enter the other past medical history",
  MOBILE_PRELIMINARY_PAST_HISTORY_NOT_SURE: "None",

  MOBILE_PRELIMINARY_FAMILY_HISTORY_DESC:
    "If you have any of the following past medical history in your family, please select all of them.",
  MOBILE_PRELIMINARY_FAMILY_HISTORY_TITLE1: "Hypertension",
  MOBILE_PRELIMINARY_FAMILY_HISTORY_TITLE2: "Diabetes",
  MOBILE_PRELIMINARY_FAMILY_HISTORY_TITLE3: "Tuberculosis",
  MOBILE_PRELIMINARY_FAMILY_HISTORY_TITLE4: "Cancer",
  MOBILE_PRELIMINARY_FAMILY_HISTORY_TITLE5: "Other",
  MOBILE_PRELIMINARY_FAMILY_HISTORY_INPUT_PLACEHOLDER:
    "Enter the other family medical history",
  MOBILE_PRELIMINARY_FAMILY_HISTORY_NOT_SURE: "None",

  MOBILE_PRELIMINARY_SMOKE_DESC: "Do you smoke?",
  MOBILE_PRELIMINARY_SMOKE_YES: "Yes",
  MOBILE_PRELIMINARY_SMOKE_NO: "No",
  MOBILE_PRELIMINARY_SMOKE_NOT_NOW: "I used to smoke but quit",

  MOBILE_PRELIMINARY_DRINK_DESC: "Do you drink alcohol?",
  MOBILE_PRELIMINARY_DRINK_YES: "Yes",
  MOBILE_PRELIMINARY_DRINK_NO: "No",
  MOBILE_PRELIMINARY_DRINK_NOT_NOW: "I used to drink but quit",

  MOBILE_PRELIMINARY_PAST_SURGERIES_DESC: "Have you had any surgery?",
  MOBILE_PRELIMINARY_PAST_SURGERIES_TITLE1: "Thyroid surgery",
  MOBILE_PRELIMINARY_PAST_SURGERIES_TITLE2: "C-section",
  MOBILE_PRELIMINARY_PAST_SURGERIES_TITLE3: "Nephrectomy",
  MOBILE_PRELIMINARY_PAST_SURGERIES_TITLE4: "Plastic surgery",
  MOBILE_PRELIMINARY_PAST_SURGERIES_TITLE5: "Heart surgery",
  MOBILE_PRELIMINARY_PAST_SURGERIES_TITLE6: "Tumor removal surgery",
  MOBILE_PRELIMINARY_PAST_SURGERIES_TITLE7: "Other",
  MOBILE_PRELIMINARY_PAST_SURGERIES_INPUT_PLACEHOLDER:
    "Enter the other surgery",
  MOBILE_PRELIMINARY_PAST_SURGERIES_NOT_SURE: "None",

  MOBILE_PRELIMINARY_PAST_MEDICINE_DESC: "Have you taken any medicine?",
  MOBILE_PRELIMINARY_PAST_MEDICINE_SUBDESC:
    "If you didn't take any medicine, select `None`",
  MOBILE_PRELIMINARY_PAST_MEDICINE_INPUT_PLACEHOLDER: "Enter the medicine",

  MOBILE_PRELIMINARY_ALLERGY_DESC: "Do you have any allergies?",
  MOBILE_PRELIMINARY_ALLERGY_SUBDESC:
    "If you don't have any allergies, select `None`",
  MOBILE_PRELIMINARY_ALLERGY_TITLE1: "Medicine",
  MOBILE_PRELIMINARY_ALLERGY_TITLE2: "Food",
  MOBILE_PRELIMINARY_ALLERGY_TITLE3: "Flower",
  MOBILE_PRELIMINARY_ALLERGY_TITLE4: "Animal hair",
  MOBILE_PRELIMINARY_ALLERGY_TITLE5: "Dust",
  MOBILE_PRELIMINARY_ALLERGY_TITLE6: "Metal",
  MOBILE_PRELIMINARY_ALLERGY_TITLE7: "Other",
  MOBILE_PRELIMINARY_ALLERGY_INPUT_PLACEHOLDER: "Enter the allergy",
  MOBILE_PRELIMINARY_ALLERGY_NOT_SURE: "None",

  MOBILE_PRELIMINARY_TODOCTOR_DESC: "Do you want to tell the doctor anything?",
  MOBILE_PRELIMINARY_TODOCTOR_SUBDESC:
    "If you don't want to tell the doctor anything, select `None`",
  MOBILE_PRELIMINARY_TODOCTOR_INPUT_PLACEHOLDER:
    "Enter the content you want to tell the doctor",
  MOBILE_PRELIMINARY_TODOCTOR_NOT_SURE: "None",

  HISTORY_SEARCH_BOX_SELECT_PERIOD: "Select period",
  HISTORY_SEARCH_HOSPITAL_NAME: "Hospital name",
  HISTORY_SEARCH_STATUS: "Status",
  HISTORY_SEARCH_PERIOD_TOTAL: "Total",
  HISTORY_SEARCH_PERIOD_TODAY: "Today",
  HISTORY_SEARCH_PERIOD_3DAYS: "3 days",
  HISTORY_SEARCH_PERIOD_1WEEK: "1 week",
  HISTORY_SEARCH_PERIOD_1MONTH: "1 month",
  HISTORY_SEARCH_PERIOD_3MONTHS: "3 months",
  HISTORY_SEARCH_PERIOD_6MONTHS: "6 months",
  HISTORY_SEARCH_PERIOD_1YEAR: "1 year",
  HISTORY_SEARCH_DOCTOR: "Doctor",
  HISTORY_SEARCH_SPECIALTY: "Specialty",
  HISTORY_SEARCH_SEARCH: "Search",
  HISTORY_SEARCH_RESET: "Reset",
  HISTORY_SEARCH_SEARCH_PLACEHOLDER: "Enter a search term",
  HISTORY_SEARCH_STATUS_WAITING: "Waiting",
  HISTORY_SEARCH_STATUS_COMPLETED: "Completed",
  HISTORY_SEARCH_STATUS_PRESCRIBED: "Prescribed",
  HISTORY_SEARCH_START_DATE: "Start date",
  HISTORY_SEARCH_END_DATE: "End date",

  HISTORY_TABLE_TITLE: "History",
  HISTORY_TABLE_COUNT: "count",
  HISTORY_TABLE_SELECTED: "selected",
  HISTORY_TABLE_NO: "No",
  HISTORY_TABLE_DOCTOR: "Doctor",
  HISTORY_TABLE_DEPARTMENT: "Department",
  HISTORY_TABLE_CO_DOCTOR: "Co-doctor",
  HISTORY_TABLE_CO_DEPARTMENT: "Co-department",
  HISTORY_TABLE_HOSPITAL: "Hospital",
  HISTORY_TABLE_COUNTRY: "Country",
  HISTORY_TABLE_PATIENT_ID: "Patient ID",
  HISTORY_TABLE_STATUS: "Status",
  HISTORY_TABLE_TELE_DATE: "Teleconsulting date",
  HISTORY_TABLE_DOWNLOAD_MESSAGE: "Downloaded history",
